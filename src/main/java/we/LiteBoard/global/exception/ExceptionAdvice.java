...
import we.LiteBoard.global.response.ErrorResponse;
import we.LiteBoard.global.response.result.ExceptionResult;

import java.util.ArrayList;
import java.util.List;

import static we.LiteBoard.global.exception.ErrorCode.PARAMETER_GRAMMAR_ERROR;
import static we.LiteBoard.global.exception.ErrorCode.PARAMETER_VALIDATION_ERROR;
